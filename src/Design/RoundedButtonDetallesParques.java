...
public class RoundedButtonDetallesParques extends JButton {
    ...
    private Color borderColor = new Color(0xC6, 0xD3, 0xC7);

    private Color currentColor = normalColor;

    public RoundedButtonDetallesParques(String text) {
        super(text);
