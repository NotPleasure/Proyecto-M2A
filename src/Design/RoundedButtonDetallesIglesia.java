...
public class RoundedButtonDetallesIglesia extends JButton {
    ...
    private Color borderColor = new Color(0xE4, 0xC1, 0x9E);

    private Color currentColor = normalColor;

    public RoundedButtonDetallesIglesia(String text) {
        super(text);
