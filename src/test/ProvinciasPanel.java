...
public class ProvinciasPanel extends JPanel {
    private ProvinciaDAO provinciaDAO;
    private DefaultTableModel tableModel;
    private JTable table;
    private JTextField txtNombre, txtId, txtBuscar;
    private JButton btnCrear, btnActualizar, btnEliminar, btnBuscar, btnLimpiar;
    private JLabel lblEstadisticas;

    public ProvinciasPanel() {
    ...
    private void setupEventListeners() {
        btnCrear.addActionListener(e -> crearProvincia());
        btnActualizar.addActionListener(e -> actualizarProvincia());
        btnEliminar.addActionListener(e -> eliminarProvincia());
        btnBuscar.addActionListener(e -> buscarProvincia());
        ...
        txtBuscar.addActionListener(e -> buscarProvincia());
    }
