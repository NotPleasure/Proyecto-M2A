 ...
 * @author USER
 */
public class Ventana_ActualizarRestaurantes extends javax.swing.JPanel {

    private JTextArea textArea;
    private byte[] imagenBytes1;
    private byte[] imagenBytes2;
    private byte[] imagenBytes3;
    private Controlador.ControladorRestaurante controlador;
    private int id_negocio;
    private final Ventana_AdministrarRestaurantes ventanaPadre;
   ...
   // private final Ventana_AdministrarMuseos ventanaPadre;
     ...
     */
    public Ventana_ActualizarRestaurantes(Ventana_AdministrarRestaurantes padre) {
        initComponents();
    ...
    public void cargarDatosMuseo(Restaurante vista) {
        this.id_negocio = vista.getId_negocio();

        NombreNegocio.setText(vista.getNombre() != null
                ? vista.getNombre()
                : "");
         txtEspecialidad.setText(vista.getEspecialidad() != null
                ? vista.getEspecialidad()
                : "");
         txtCategoria.setText(vista.getCategoria() != null
                ? vista.getCategoria()
                : "");
         txtTipo_Cocina.setText(vista.getTipo_cocina() != null
                ? vista.getTipo_cocina()
                : "");
    ...
    private void initComponents() {
        ...
        jPanel3.add(NombreNegocio, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 140, 410, 40));
    ...
    private void GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GuardarActionPerformed
        try {
            ...
            ControladorRestaurante ctrl = new ControladorRestaurante();
              boolean ok = ctrl.actualizarRestauranteCompleto(capacidad, tipo_cocina, categoria, especialidad, id_negocio, nombre, direccion, latitud, longitud, desc, ha, hc, imagenBytes1, imagenBytes2, imagenBytes3 );
