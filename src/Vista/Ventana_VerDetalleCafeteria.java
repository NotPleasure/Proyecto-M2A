 ...
 * @author USER
 */
public class Ventana_VerDetalleCafeteria extends javax.swing.JFrame {

    private JXMapViewer mapViewer;
    private WaypointPainter<Waypoint> waypointPainter;
    private Set<Waypoint> waypoints = new HashSet<>();
    private JTextArea textArea;
    private Ventana_TarjetasCafeteria ventanaTarjetas;

    /**
     * Creates new form Ventana_VerIglesias
     */
    public Ventana_VerDetalleCafeteria() {
        setUndecorated(true);
        initComponents();
    ...
    public Ventana_VerDetalleCafeteria(Cafeterias detalle) {
        this();
        ...
        lblCategoria.setText(detalle.getTematica());
    ...
    public void setVentanaTarjetas(Ventana_TarjetasCafeteria v) {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 20, 80, 70));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_VerDetalleCafeteria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_VerDetalleCafeteria().setVisible(true);
            }
        });
    }
