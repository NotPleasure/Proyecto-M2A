 ...
 * @author USER
 */
public class Ventana_ActualizarIglesia extends javax.swing.JPanel {
    ...
    private Ventana_AdministrarIglesias ventanalugares;

    /**
     * Creates new form Ventana_InsertarIglesia
     */
    public Ventana_ActualizarIglesia(Ventana_AdministrarIglesias ventanalugares) {
        initComponents();
        this.ventanalugares = ventanalugares;
    ...
    public void cargarDatosIglesia(IglesiaDetalleVista vista) {
        this.lugarInteresId = vista.getId();

        NombreLugar.setText(vista.getNombre() != null
                ? vista.getNombre()
                : "");
        ...
        if (vista.getHoraCierre() != null) {
            System.out.println("Hora cierre en DTO: " + vista.getHoraCierre());
            System.out.println("Nombre del campo en panel: " + Horacierre.getName());
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 0, 70, 90));

        Registro.setFont(new java.awt.Font("Segoe UI", 0, 30)); // NOI18N
        Registro.setForeground(new java.awt.Color(255, 255, 255));
        Registro.setText("Actualizar Iglesia");
        ...
        Categorias4.setText("Información de la Iglesia");
        ...
        jPanel5.add(Horacierre, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 130, 290, 40));
        ...
        jPanel5.add(HoraApertura, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, 290, 40));
    ...
    private void GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GuardarActionPerformed
        try {
            ...
            ControladorActualizarIglesia ctrl = new ControladorActualizarIglesia();
            boolean ok = ctrl.actualizarIglesiaCompleto(
                    lugarInteresId,
                    nombre,
                    direccion,
                    latitud,
            ...
            if (ok) {
                JOptionPane.showMessageDialog(this,
                        "Iglesia actualizada correctamente.",
                        "Éxito",
                        JOptionPane.INFORMATION_MESSAGE);
                GlassPanePopup.closePopupLast();
                ventanalugares.recargarTablaIglesias();
