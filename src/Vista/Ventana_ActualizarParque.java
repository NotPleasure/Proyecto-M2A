...
import Controlador.ControladorActualizarParque;
 ...
 * @author USER
 */
public class Ventana_ActualizarParque extends javax.swing.JPanel {
    ...
    private final Ventana_AdministrarParques ventanaPadre;

    /**
     * Creates new form Ventana_InsertarIglesia
     */
    public Ventana_ActualizarParque(Ventana_AdministrarParques ventanaPadre) {
    ...
    public void cargarDatosParque(ParqueDetalleVista vista) {
        this.idParque = vista.getId();

        NombreLugar.setText(vista.getNombre() != null ? vista.getNombre() : "");

        EntidadGestora.setText(
                vista.getEntidad_gestora() != null
                ? vista.getEntidad_gestora()
                : ""
        );

        Superficie.setText(String.valueOf(vista.getSuperficie()));

        Direccion.setText(vista.getDireccion() != null ? vista.getDireccion() : "");

        Latitud.setText(String.valueOf(vista.getLatitud()));
        Longitud.setText(String.valueOf(vista.getLongitud()));

        textArea.setText(vista.getDescripcion() != null ? vista.getDescripcion() : "");

        if (vista.getImagen1() != null) {
            imagenBytes1 = vista.getImagen1();
            roundedImageLabel1.setIcon(new ImageIcon(imagenBytes1));
        }
        if (vista.getImagen2() != null) {
            imagenBytes2 = vista.getImagen2();
            roundedImageLabel2.setIcon(new ImageIcon(imagenBytes2));
        }
        if (vista.getImagen3() != null) {
            imagenBytes3 = vista.getImagen3();
            roundedImageLabel3.setIcon(new ImageIcon(imagenBytes3));
        }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 20, 60, 60));

        Registro.setFont(new java.awt.Font("Segoe UI", 0, 30)); // NOI18N
        Registro.setForeground(new java.awt.Color(255, 255, 255));
        Registro.setText("Actualización de Parques");
        jPanel1.add(Registro, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 26, -1, -1));

        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1360, 100));
    ...
    private void GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GuardarActionPerformed
        ...
        try {
            ...
            String entidad = EntidadGestora.getText().trim();
            float superficie = Float.parseFloat(Superficie.getText().trim());
            ...
            ControladorActualizarParque ctrl = new ControladorActualizarParque();
            boolean ok = ctrl.actualizarParqueCompleto(
                    idParque,
                    nombre,
                    direccion,
                    latitud,
            ...
            if (ok) {
                ...
                GlassPanePopup.closePopupLast();
                ventanaPadre.recargarTablaParques();
            } else {
                JOptionPane.showMessageDialog(this,
    ...
    private void CargarImagenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CargarImagenActionPerformed
        ...
        datos = ImagenUtils.seleccionarYConvertirImagen(
                slot == 1 ? roundedImageLabel1
                        : slot == 2 ? roundedImageLabel2
                                : roundedImageLabel3
        );
        ...
        switch (slot) {
            case 1:
                imagenBytes1 = datos;
                roundedImageLabel1.setImagenDesdeBytes(datos);
                break;
            case 2:
                imagenBytes2 = datos;
                roundedImageLabel2.setImagenDesdeBytes(datos);
                break;
            case 3:
                imagenBytes3 = datos;
                roundedImageLabel3.setImagenDesdeBytes(datos);
                break;
        }
