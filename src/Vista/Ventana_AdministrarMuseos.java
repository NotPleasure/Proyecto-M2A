 ...
 * @author USER
 */
public class Ventana_AdministrarMuseos extends javax.swing.JFrame {

    private List<MuseoVista> listaMuseosCompleta = new ArrayList<>();
    private Persona personaLogueada;
    private boolean sinBordes = true;
    private JFrame ventanaDestino;

    public Ventana_AdministrarMuseos(JFrame padre, boolean sinBordes) {
    ...
    private void cargarTablaMuseos() {
        try {
            ...
            listaMuseosCompleta = dao.buscarSoloTexto("");
    ...
    private void poblarTablaMuseos(List<MuseoVista> lista) {
        String[] columnas = {"ID", "Nombre", "Apertura", "Cierre"};
        DefaultTableModel modelo = new DefaultTableModel(null, columnas);

        for (MuseoVista m : lista) {
            Object[] fila = {
                m.getId(),
                m.getNombre(),
                m.getHoraApertura(),
  ...
  int fila = jTable1.getSelectedRow();
    ...
    try {
        MuseoDAO dao = new MuseoDAO();
        MuseoDetalleVista vista = dao.obtenerDetalleMuseo(lugarInteresId);

        if (vista == null) {
            JOptionPane.showMessageDialog(
                this,
                "No se encontraron datos del museo seleccionado.",
                "Error",
        ...
        Ventana_ActualizarMuseos panel = new Ventana_ActualizarMuseos(this);
        ...
        JOptionPane.showMessageDialog(
            this,
            "Error al cargar datos del museo:\n" + ex.getMessage(),
            "Error",
            JOptionPane.ERROR_MESSAGE
        );
    }
    ...
    private void EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        ...
        System.out.println("ID seleccionado a eliminar: " + lugarInteresId + ", Nombre: " + nombre);

        mostrarConfirmacionEliminarMuseo(lugarInteresId, nombre);
    ...
    private void mostrarConfirmacionEliminarMuseo(int id, String nombre) {
        Ventana_EliminarMuseo panel = new Ventana_EliminarMuseo(this);
