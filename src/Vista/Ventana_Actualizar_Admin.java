 ...
 * @author USER
 */
public class Ventana_Actualizar_Admin extends javax.swing.JPanel {
private CircularImageLabel lblFotoPerfil;
    ...
    /**
     * Creates new form Ventana_Actualizar_Admin
     */
    public Ventana_Actualizar_Admin() {
        initComponents();
 ...
 //Método para cargar Nacionalidades:
    ...
    public void cargarDatosUsuario(Usuario usuario) {
        ...
        getTxtCedula().setText(usuario.getCedula() != null ? usuario.getCedula() : "");
        getNombres().setText(usuario.getNombres() != null ? usuario.getNombres() : "");
        getApellidos().setText(usuario.getApellidos() != null ? usuario.getApellidos() : "");

        if (usuario.getFechaNacimiento() != null) {
            DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy");
            getFecha().setText(usuario.getFechaNacimiento().format(formatter));
        } else {
            getFecha().setText("");
        }

        getGeneros().setSelectedItem(usuario.getGenero() != null ? usuario.getGenero() : "");
        getNacionalidades().setSelectedItem(usuario.getNacionalidad() != null ? usuario.getNacionalidad() : "");
        getCorreoElectronico().setText(usuario.getCorreo() != null ? usuario.getCorreo() : "");
        getTxtNombredeusuario().setText(usuario.getUsuario() != null ? usuario.getUsuario() : "");
        getTxtSobreMi().setText(usuario.getSobreMi() != null ? usuario.getSobreMi() : "");

        if (usuario.getIcono() != null) {
            ImageIcon icon = new ImageIcon(usuario.getIcono());
            getLblFotoPerfil().setIcon(icon);
        }
    }
    
    public void cargarDatosAdministrador(Administrador admin) {
    getTxtCedula().setText(admin.getCedula() != null ? admin.getCedula() : "");
    getNombres().setText(admin.getNombres() != null ? admin.getNombres() : "");
    getApellidos().setText(admin.getApellidos() != null ? admin.getApellidos() : "");
    if (admin.getFechaNacimiento() != null) {
        DateTimeFormatter fmt = DateTimeFormatter.ofPattern("dd/MM/yyyy");
        getFecha().setText(admin.getFechaNacimiento().format(fmt));
    } else {
        getFecha().setText("");
    }
    getGeneros().setSelectedItem(admin.getGenero() != null ? admin.getGenero() : "");
    getNacionalidades().setSelectedItem(admin.getNacionalidad() != null ? admin.getNacionalidad() : "");
    getCorreoElectronico().setText(admin.getCorreo() != null ? admin.getCorreo() : "");
    getTxtNombredeusuario().setText(admin.getUsuario() != null ? admin.getUsuario() : "");
    getTxtSobreMi().setText(admin.getSobreMi() != null ? admin.getSobreMi() : "");
    if (admin.getIcono() != null) {
        getLblFotoPerfil().setIcon(new ImageIcon(admin.getIcono()));
    }
}
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(3, 187, 133));
        jPanel2.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        Registro.setForeground(new java.awt.Color(255, 255, 255));
        Registro.setText("Actualizar Usuario");
        jPanel2.add(Registro, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 20, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imágenes/actualizar (1).png"))); // NOI18N
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 20, 60, 60));
        ...
        jPanel1.add(Cedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 130, -1, -1));

        txtCedula.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jPanel1.add(txtCedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 160, 250, 40));

        NombreUser.setForeground(new java.awt.Color(0, 0, 0));
        NombreUser.setText("Nombre de Usuario");
        jPanel1.add(NombreUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 220, -1, -1));

        txtNombredeusuario.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jPanel1.add(txtNombredeusuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 260, 250, 40));

        Correo.setForeground(new java.awt.Color(0, 0, 0));
        Correo.setText("Correo Electrónico");
        jPanel1.add(Correo, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 320, -1, -1));
        jPanel1.add(CorreoElectronico, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 360, 250, 40));

        Nacionalidad.setForeground(new java.awt.Color(0, 0, 0));
        Nacionalidad.setText("Nacionalidad");
        jPanel1.add(Nacionalidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 430, -1, -1));
        ...
        jPanel1.add(Nacionalidades, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 470, 250, 40));

        Nombre.setForeground(new java.awt.Color(0, 0, 0));
        Nombre.setText("Nombres");
        jPanel1.add(Nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 130, -1, -1));

        Nombres.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jPanel1.add(Nombres, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 160, 250, 40));

        Apellido.setForeground(new java.awt.Color(0, 0, 0));
        Apellido.setText("Apellidos");
        jPanel1.add(Apellido, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 220, -1, -1));

        Apellidos.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jPanel1.add(Apellidos, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 250, 250, 40));

        Fecha_Nacimiento.setForeground(new java.awt.Color(0, 0, 0));
        Fecha_Nacimiento.setText("Fecha de Nacimiento");
        jPanel1.add(Fecha_Nacimiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 320, -1, -1));
        jPanel1.add(PanelFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 360, 250, 40));

        Género.setForeground(new java.awt.Color(0, 0, 0));
        Género.setText("Género");
        jPanel1.add(Género, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 430, -1, -1));
        ...
        jPanel1.add(Generos, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 470, 250, 40));

        Contraseña.setForeground(new java.awt.Color(0, 0, 0));
        Contraseña.setText("Contraseña");
        jPanel1.add(Contraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 130, -1, 20));

        Contrasenia.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jPanel1.add(Contrasenia, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 160, 250, 40));

        Sobre.setForeground(new java.awt.Color(0, 0, 0));
        Sobre.setText("Sobre Mí");
        jPanel1.add(Sobre, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 220, -1, 20));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 170, 40, 20));
        jPanel1.add(SobreMi, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 250, 260, 150));

        Cargar.setText("Cargar Imagen");
        jPanel1.add(Cargar, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 420, -1, -1));
        ...
        jPanel1.add(Limpiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 474, 260, 30));
        jPanel1.add(panelFotoPerfil, new org.netbeans.lib.awtextra.AbsoluteConstraints(1140, 400, 100, 120));
        ...
        jPanel1.add(Aceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 580, 100, 30));
        ...
        jPanel1.add(Cancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 580, 100, 30));

        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1290, 650));
