 ...
 * @author USER
 */
public class Ventana_VerDetalleParques extends javax.swing.JFrame {
     ...
     */
    public Ventana_VerDetalleParques() {
        setUndecorated(true);
        initComponents();
        ...
        Entidad_Gestora.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 15));
        Superficie.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 15));
    ...
    public Ventana_VerDetalleParques(ParqueDetalleVista detalle) {
        this();

        NombreIglesia.setText(detalle.getNombre());
        Entidad_Gestora.setText(detalle.getEntidad_gestora());
        Superficie.setText(String.valueOf(detalle.getSuperficie()));
        lblLatitud.setText(String.valueOf((float) detalle.getLatitud()));
    ...
    private void initComponents() {
        ...
        Entidad_Gestora = new javax.swing.JLabel();
        ...
        jPanel2.setBackground(new java.awt.Color(0, 167, 81));
        ...
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 20, 60, 60));
        ...
        HoraApe.setText("Entidad_Gestora");
        ...
        HoraCiere.setText("Superficie");
        jPanel4.add(HoraCiere, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 156, -1, -1));

        Entidad_Gestora.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        Entidad_Gestora.setForeground(new java.awt.Color(51, 51, 51));
        jPanel4.add(Entidad_Gestora, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 94, 140, 30));

        Superficie.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        Superficie.setForeground(new java.awt.Color(51, 51, 51));
        jPanel4.add(Superficie, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 150, 180, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_VerDetalleParques.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_VerDetalleParques().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel Entidad_Gestora;
