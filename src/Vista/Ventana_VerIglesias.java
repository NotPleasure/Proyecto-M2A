 ...
 * @author USER
 */
public class Ventana_VerIglesias extends javax.swing.JFrame {

    private JXMapViewer mapViewer;
    private WaypointPainter<Waypoint> waypointPainter;
    private Set<Waypoint> waypoints = new HashSet<>();
    private JTextArea textArea;
    private Ventana_TarjetasIglesia ventanaTarjetas;

    /**
     * Creates new form Ventana_VerIglesias
     */
    public Ventana_VerIglesias() {
        setUndecorated(true);
        initComponents();
    ...
    public Ventana_VerIglesias(IglesiaDetalleVista detalle) {
        this();
    ...
    public void setVentanaTarjetas(Ventana_TarjetasIglesia v) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_VerIglesias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_VerIglesias().setVisible(true);
            }
        });
    }
