...
import Design.RoundedPanelAdminEncabezado;
 ...
 * @author USER
 */
public class Ventana_UsuarioPrincipal extends javax.swing.JFrame {

    private boolean sinBordes = true;
    private List<Usuario> listaUsuariosCompleta = new ArrayList<>();
    private Persona personaLogueada;

    public Ventana_UsuarioPrincipal(boolean sinBordes, Persona persona) {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(27, 86, 149));
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 90, 1230, 450));
    ...
    private void InsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertarActionPerformed
        ...
        Ventana_Formulario_Usuario ayudaPanel = new Ventana_Formulario_Usuario();

        GlassPanePopup.showPopup(ayudaPanel);
        new ControladorUsuarioPrincipal(ayudaPanel, this);
    ...
    private void ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ActualizarActionPerformed
        ...
        UsuarioDAO dao = new UsuarioDAO();
        Usuario usuario = dao.obtenerPorId(idPersona);

        if (usuario != null) {
            Ventana_Actualizar_UsuarioPrincipal form = new Ventana_Actualizar_UsuarioPrincipal();

            form.cargarDatosUsuario(usuario);

            new ControladorActualizarUsuarioPrincipal(form, usuario, this);
    ...
    private void mostrarConfirmacionEliminar(int idPersona, String usuario) {
        Ventana_EliminarUsuarioPrincipal popup = new Ventana_EliminarUsuarioPrincipal(this);
        popup.setLabelNombre(usuario);
        popup.setLabelId(String.valueOf(idPersona));
        popup.setIdPersona(idPersona);
