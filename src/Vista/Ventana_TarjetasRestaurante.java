 ...
 * @author USER
 */
public class Ventana_TarjetasRestaurante extends javax.swing.JFrame {

    private List<Restaurante> museosGuardados;
    private ControladorRestaurante ctrl = new ControladorRestaurante();
    private JFrame ventanaTarjetas;

    /**
     * Creates new form Ventana_TarjetasIglesia
     */
    public Ventana_TarjetasRestaurante() {
        initComponents();
    ...
    public void cargarRestaurantes() {
        try {
            List<Restaurante> lista = ctrl.obtenerRestaurantesVista();

            for (Restaurante iv : lista) {
                agregarTarjeta(iv.getId_negocio(), iv.getNombre(), iv.getHora_apertura(), iv.getHora_cierre(), iv.getImagenPrincipal());
            }
    ...
    public void agregarTarjeta(int id, String nombre, LocalTime horaApertura, LocalTime horaCierre, byte[] imagen) {
        PanelCardRestaurante tarjeta = new PanelCardRestaurante(id, nombre, horaApertura, horaCierre, imagen);
    ...
    private void initComponents() {
        ...
        Registro.setText("Mis Restaurantes");
        jPanel1.add(Registro, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 22, 240, -1));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imágenes/RestauranteB.png"))); // NOI18N
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 10, 80, 70));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_TarjetasRestaurante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_TarjetasRestaurante().setVisible(true);
            }
        });
    }
