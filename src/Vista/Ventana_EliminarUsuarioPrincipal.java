 ...
 * @author USER
 */
public class Ventana_EliminarUsuarioPrincipal extends javax.swing.JPanel {
     ...
     */
    public Ventana_EliminarUsuarioPrincipal(Ventana_UsuarioPrincipal ventanaPrincipal) {
        initComponents();
    ...
    private void EliminarUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarUserActionPerformed
        ...
        if (dao.eliminarCompleto(idPersona)) {
            ...
            ventanaPrincipal.recargarTabla();
        } else {
