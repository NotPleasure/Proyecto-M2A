 ...
 * @author USER
 */
public class Ventana_InsertarCafeteria extends javax.swing.JPanel {
   ...
   // private final Ventana_AdministrarMuseos ventanaPadre;
     ...
     */
    public Ventana_InsertarCafeteria() {
        initComponents();
    ...
    private void GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GuardarActionPerformed
        try {
            ...
            ControladorCafeteria ctrl = new ControladorCafeteria();
               ctrl.guardarRestaurante(WIDTH, nombre, desc, String.valueOf(ha),String.valueOf(hc), capacidad,tematica , direccion, latitud, longitud, imagenBytes1, imagenBytes2, imagenBytes3);
