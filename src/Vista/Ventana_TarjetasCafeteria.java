 ...
 * @author USER
 */
public class Ventana_TarjetasCafeteria extends javax.swing.JFrame {

    private List<Cafeterias> museosGuardados;
    private ControladorCafeteria ctrl = new ControladorCafeteria();
    private JFrame ventanaTarjetas;

    /**
     * Creates new form Ventana_TarjetasIglesia
     */
    public Ventana_TarjetasCafeteria() {
        initComponents();
    ...
    public void cargarCafeterias() {
        try {
            List<Cafeterias> lista = ctrl.obtenerCafeteriaVista();

            for (Cafeterias iv : lista) {
    ...
    public void agregarTarjeta(int id, String nombre, LocalTime horaApertura, LocalTime horaCierre, byte[] imagen) {
        PanelCardCafeteria tarjeta = new PanelCardCafeteria(id, nombre, horaApertura, horaCierre, imagen);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_TarjetasCafeteria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_TarjetasCafeteria().setVisible(true);
            }
        });
    }
