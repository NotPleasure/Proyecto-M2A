 ...
 * @author USER
 */
public class Ventana_ActualizarCafeteria extends javax.swing.JPanel {

    private JTextArea textArea;
    private byte[] imagenBytes1;
    private byte[] imagenBytes2;
    private byte[] imagenBytes3;
    private Controlador.ControladorCafeteria controlador;
    private int id_negocio;
    private final Ventana_AdministrarCafeterias ventanaPadre;
   ...
   // private final Ventana_AdministrarMuseos ventanaPadre;
     ...
     */
    public Ventana_ActualizarCafeteria(Ventana_AdministrarCafeterias padre) {
        initComponents();
        ...
        public void cargarDatosMuseo(Cafeterias vista) {
        this.id_negocio = vista.getId_negocio();

        NombreNegocio.setText(vista.getNombre() != null
                ? vista.getNombre()
                : "");
         txtTematica.setText(vista.getTematica() != null
                ? vista.getTematica()
                : "");
      
        HoraApertura.setText(vista.getHora_apertura() != null
                ? vista.getHora_apertura() .toString()
                : "");
        if (vista.getHora_cierre() != null) {
            Horacierre.setText(vista.getHora_cierre() .toString());
        } else {
            Horacierre.setText("");
        }
        ...
        txtADescripcion.setText(vista.getDescripcion() != null
    ...
    private void initComponents() {
        ...
        NombreNegocio = new RoundedTextField2(20);
        ...
        txtTematica = new RoundedTextField2(20);
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 10, 70, 80));
        ...
        NombreNegocio.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jPanel3.add(NombreNegocio, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, 410, 40));
        ...
        jPanel4.add(roundedImageLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(282, 80, 190, 110));
        ...
        Categorias4.setText("Información de la Cafeteria");
        ...
        txtTematica.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jPanel5.add(txtTematica, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, 410, 40));

        NomLugar2.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        NomLugar2.setForeground(new java.awt.Color(44, 62, 80));
        NomLugar2.setText("Tematica");
        ...
        add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 590, 720, 200));
        ...
        add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 880, 150, 30));

        btnActualizar.setBackground(new java.awt.Color(255, 102, 51));
        btnActualizar.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnActualizar.setForeground(new java.awt.Color(255, 255, 255));
        btnActualizar.setText("Insertar");
        add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 850, 110, -1));

        btnCancelar.setBackground(new java.awt.Color(255, 102, 51));
        btnCancelar.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnCancelar.setForeground(new java.awt.Color(255, 255, 255));
        btnCancelar.setText("Cancelar");
        add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 860, 140, -1));
        ...
        add(Cancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 860, 180, 30));
        ...
        add(Guardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 850, 180, 30));
    ...
    private void GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GuardarActionPerformed
        try {
            if (CapacidadNegocio.getText().trim().isEmpty()
                    ...
                    ||txtTematica.getText().trim().isEmpty()
            ...
            ControladorCafeteria ctrl = new ControladorCafeteria();
              boolean ok = ctrl.actualizarCafeteriaCompleto(capacidad, tematica, id_negocio, nombre, direccion, latitud, longitud, desc, ha, hc, imagenBytes1, imagenBytes2, imagenBytes3);
