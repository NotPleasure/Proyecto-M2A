 ...
 * @author USER
 */
public class PanelCardRestaurante extends javax.swing.JPanel {
    ...
    public PanelCardRestaurante(int id,String nombre,  LocalTime horaapertura,LocalTime horacierre, byte[] imagenBytes) {
        initComponents();
        this.vista =new Restaurante(id,nombre,horaapertura,horacierre,imagenBytes);
