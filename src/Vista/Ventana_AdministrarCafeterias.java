 ...
 * @author USER
 */
public class Ventana_AdministrarCafeterias extends javax.swing.JFrame {

    private List<Cafeterias> listaMuseosCompleta = new ArrayList<>();
    private Persona personaLogueada;
    private boolean sinBordes = true;
    private JFrame ventanaDestino;

    public Ventana_AdministrarCafeterias(JFrame padre, boolean sinBordes) {
    ...
    private void cargarTablaMuseos() {
        try {
            CafeteriasDAO dao = new CafeteriasDAO();
    ...
    private void poblarTablaMuseos(List<Cafeterias> lista) {
        String[] columnas = {"ID", "Nombre", "Apertura", "Cierre"};
        DefaultTableModel modelo = new DefaultTableModel(null, columnas);

        for (Cafeterias r : lista) {
            Object[] fila = {
                r.getId_negocio(),
                r.getNombre(),
                r.getHora_apertura(),
  ...
  int fila = jTable1.getSelectedRow();
    ...
    try {
        CafeteriasDAO dao = new CafeteriasDAO();
        Cafeterias vista = dao.obtenerDetalleCafeteria(neogicoid);
        ...
        Ventana_ActualizarCafeteria panel = new Ventana_ActualizarCafeteria(this);
    ...
    private void mostrarConfirmacionEliminarMuseo(int id, String nombre) {
        Ventana_EliminarCafeteria panel = new Ventana_EliminarCafeteria(this);
