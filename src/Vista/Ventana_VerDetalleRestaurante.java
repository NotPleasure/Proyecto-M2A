 ...
 * @author USER
 */
public class Ventana_VerDetalleRestaurante extends javax.swing.JFrame {

    private JXMapViewer mapViewer;
    private WaypointPainter<Waypoint> waypointPainter;
    private Set<Waypoint> waypoints = new HashSet<>();
    private JTextArea textArea;
    private Ventana_TarjetasRestaurante ventanaTarjetas;

    /**
     * Creates new form Ventana_VerIglesias
     */
    public Ventana_VerDetalleRestaurante() {
        setUndecorated(true);
        initComponents();
    ...
    public Ventana_VerDetalleRestaurante(Restaurante detalle) {
        this();

        NombreIglesia.setText(detalle.getNombre());
        HoraApertura.setText(detalle.getHora_apertura() != null ? detalle.getHora_apertura().toString() : "");
        HoraCierre.setText(detalle.getHora_cierre() != null ? detalle.getHora_cierre().toString() : "");
        ...
        lblCategoria.setText(detalle.getCategoria());
    ...
    public void setVentanaTarjetas(Ventana_TarjetasRestaurante v) {
    ...
    private void initComponents() {
        ...
        jPanel2.add(NombreIglesia, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 20, 470, -1));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imágenes/RestauranteD.png"))); // NOI18N
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 20, 80, 70));
        ...
        Descrip2.setFont(new java.awt.Font("Segoe UI", 0, 20)); // NOI18N
        Descrip2.setForeground(new java.awt.Color(139, 0, 0));
        Descrip2.setText("Categoria");
        jPanel3.add(Descrip2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 220, -1));

        lblCategoria.setForeground(new java.awt.Color(119, 119, 119));
        jPanel3.add(lblCategoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 320, 270, 30));

        jSeparator5.setForeground(new java.awt.Color(220, 220, 220));
        jPanel3.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 290, 360, 30));

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 490, 400, 350));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_VerDetalleRestaurante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_VerDetalleRestaurante().setVisible(true);
            }
        });
    }
