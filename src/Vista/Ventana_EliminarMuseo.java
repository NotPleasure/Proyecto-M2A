 ...
 * @author USER
 */
public class Ventana_EliminarMuseo extends javax.swing.JPanel {

    private Ventana_UsuarioPrincipal ventanaPrincipal;
    private Ventana_AdministrarMuseos ventanaPadre;
    private int idMuseo;

    /**
     * Creates new form Ventana_EliminarUsuarioPrincipal
     */
    public Ventana_EliminarMuseo(Ventana_AdministrarMuseos padre) {
        initComponents();
    ...
    private void EliminarUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarUserActionPerformed
        try {
            ...
            System.out.println("ID que se va a eliminar: " + idMuseo);
            boolean eliminado = dao.eliminarLugarInteresCompleto(idMuseo);
            if (eliminado) {
                JOptionPane.showMessageDialog(null, "Museo eliminado correctamente.");
                GlassPanePopup.closePopupLast();
                ventanaPadre.recargarTablaMuseos();
            } else {
                JOptionPane.showMessageDialog(null, "No se encontró el museo a eliminar.");
            }
