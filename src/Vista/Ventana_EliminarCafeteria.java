 ...
 * @author USER
 */
public class Ventana_EliminarCafeteria extends javax.swing.JPanel {

    private Ventana_UsuarioPrincipal ventanaPrincipal;
    private Ventana_AdministrarCafeterias ventanaPadre;
    private int idRestaurante;

    /**
     * Creates new form Ventana_EliminarUsuarioPrincipal
     */
    public Ventana_EliminarCafeteria(Ventana_AdministrarCafeterias padre) {
        initComponents();
    ...
    private void EliminarUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarUserActionPerformed
        try {
            ...
            if (eliminado) {
                JOptionPane.showMessageDialog(null, "Cafeteria eliminada correctamente.");
                GlassPanePopup.closePopupLast();
                ventanaPadre.recargarTablaMuseos();
            } else {
                JOptionPane.showMessageDialog(null, "No se encontró la cafeteria a eliminar.");
            }
