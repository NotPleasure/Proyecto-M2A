 ...
 * @author USER
 */
public class Ventana_FormularioSuperUsuario extends javax.swing.JPanel {
    ...
    /**
     * Creates new form Ventana_FormularioAdmin
     */
    public Ventana_FormularioSuperUsuario() {
        setOpaque(false);
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(255, 119, 38));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        Registro.setForeground(new java.awt.Color(255, 255, 255));
        Registro.setText("Registro de SuperUsuario");
        jPanel1.add(Registro, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 20, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imágenes/Admin User.png"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 20, 60, 40));
        ...
        add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 170, 40, 20));
